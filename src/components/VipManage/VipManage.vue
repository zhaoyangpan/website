	...
	<el-container>
	  <el-main class="main-card">
	  	...
	  	<div class="main-card-bottom">
		    ...
		    <el-table-column prop="identifier" label="登录名"  show-overflow-tooltip> </el-table-column>
		    ...
		    <el-table-column prop="groups" label="组分类" show-overflow-tooltip> </el-table-column>		    		    
		    ...
		    <!--编辑界面-->
	       	 <el-dialog title="会员信息编辑" :visible.sync="editFormVisible" width="40%">
	       	 	<el-form :model="editForm" label-width="80px" :rules="editFormRules"  ref="editForm">
			    <el-row  class="user-model">
				  <el-col :span="16">
				  	<div class="grid-content bg-purple">
			  			<el-form-item label="真实姓名" prop="realname">
							<el-input v-model="editForm.realname" style="width: 100%;" auto-complete="off"></el-input>
						</el-form-item>
						<el-form-item label="昵称" prop="nickname">
							<el-input v-model="editForm.nickname" style="width: 100%;" auto-complete="off"></el-input>
						</el-form-item>
						<el-form-item label="登录名" prop="identifier">
							<el-input v-model="editForm.identifier" style="width: 100%;" auto-complete="off"></el-input>
						</el-form-item>
						<el-form-item label="手机号" prop="phone">
							<el-input v-model="editForm.phone" style="width: 100%;" auto-complete="off"></el-input>
						</el-form-item>						
						<el-form-item label="密码" prop="credential">
							<el-input v-model="editForm.credential" style="width: 100%;" auto-complete="off"></el-input>
						</el-form-item>
		    ...
		    <!--新增界面-->
			<el-dialog title="新增会员用户" :visible.sync="addFormVisible" :close-on-click-modal="false" width="40%">
				<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
					<el-row>
					  <el-col :span="16">
							...
							<el-form-item label="登录名" prop="identifier">
								<el-input v-model="addForm.identifier" style="width: 100%;" auto-complete="off"></el-input>
							</el-form-item>
							<el-form-item label="电子邮箱" prop="email">
								<el-input v-model="addForm.email" style="width: 100%;" auto-complete="off"></el-input>
							</el-form-item>
							<el-form-item label="密码" prop="credential">
								<el-input v-model="addForm.credential" style="width: 100%;" type="password" auto-complete="off"></el-input>
							</el-form-item>
							<el-form-item label="确认密码" prop="credentialconfirm">
								<el-input v-model="addForm.credentialconfirm" style="width: 100%;" type="password" auto-complete="off"></el-input>
							</el-form-item>							
...
//						{ required: true, message: '请输入密码', trigger: 'blur' },
       ...
       methods: {
       	  //获取用户
	      getVipUsers(criteria,pageNumber, pageSize){
	      	let para = {
			...
			this.consirmpassword = '';
      		let data = [];
	        api.GetVipList(para).then(res => {	
				console.log(res)
				  let _this = this;
				  _this.totalCount = res.data.data.totalRow;			  
				  for (let i = 0; i < res.data.data.list.length; i++) {              
		            var obj = {}
		            obj.realname = res.data.data.list[i].realname;
		            ...
		            obj.credential = res.data.data.list[i].credential
		            obj.birthday = res.data.data.list[i].birthday
		            obj.identifier = res.data.data.list[i].identifier
          ...
          search: function(){
          	this.listLoading = true;
            this.getVipUsers(this.criteria, this.currentPage, this.pagesize);
          },      
       	  //每页显示数据量变更
          handleSizeChange: function(val) {
            this.pagesize = val;
            this.getVipUsers(this.currentPage, this.pagesize);
          },         	    
	      //获取管理员组
		...
		//第几页
		  ...
		  batchRemove: function () {
			...
			api.BatchDeleteVip({'ids':ids}).then((res) => {
				this.$message({
					message: '删除成功',
					type: 'success'
				});
