	  	...
	  	<div class="main-card-top">
			  ...
			  <el-col :span="20" class="search-col18">
			  	<div class="grid-content bg-purple">
					  ...
					  <el-tab-pane label="评论举报信息"></el-tab-pane>					  			  
					</el-tabs>
			  	</div>
			  </el-col>	
			  ...
			  <el-col :span="24">
			  	<div class="grid-content bg-purple">
			  		<el-form-item label="评论内容">				        
					    <el-input type="textarea" class="ident-input" style="width: 100%;" :disabled='update' v-model="identificationForm.comment_content"></el-input>
					</el-form-item>			  		
				    <el-form-item label="举报人" style="width: 50%;">				       
				        <el-input type="text" class="ident-input" :disabled='update' v-model="identificationForm.nickname"></el-input>
				    </el-form-item>
				    <el-form-item label="举报日期" style="width: 50%;">				        
				        <el-input type="text" class="ident-input" :disabled='update' v-model="identificationForm.created_time"></el-input>
				    </el-form-item>
				    <el-form-item label="举报原因" style="width: 50%;">				       
				    ...
				    <!--<el-form-item label="评论详情" style="width: 50%;">				       
	...
	export default {
       ...
       methods: {
       	//获取单条信息
       	 GetIdentificationInfo:function(){
       	 	...
       	 	let para = {
       	 	 ...
       	 	 api.GetCommentInfo(para).then(res => {
       	 	 	console.log(res)				
				this.identificationForm = {
		          ...
		          comment_content: res.data.data.comment_content,
			...
			api.CrossCommentReport(para).then((res) => {
				if(res.data.code == 200){
				    this.$message({
					message: '举报成功',
					type: 'success'
				});		
				this.addMessage('评论举报反馈','您提交的 "' +this.identificationForm.comment_content+ '" 已处理')
				this.$router.push({path:'/MomentReportManage'});
				}else{
					this.$message({
	     ...
	     RejectIdent:function(){
			...
			api.RejectCommentReport(para).then((res) => {
				console.log(res)
				if(res.data.code == 200){
				    this.$message({
					message: '已驳回',
				...
				this.addMessage('评论举报反馈',this.return_reson)
