	  	...
	  	<div class="main-card-top">
			  ...
			  <el-col :span="20" class="search-col18">
			  	<div class="grid-content bg-purple">
					  ...
					  <el-tab-pane label="店铺举报信息"></el-tab-pane>					  			  
					</el-tabs>
			  	</div>
			  </el-col>	
			  ...
			  <el-col :span="8">
			  	<div class="grid-content bg-purple">
			  		<el-form-item label="店铺名称">				        
					    <el-input type="text" class="ident-input" :disabled='update' v-model="identificationForm.store_name"></el-input>
					</el-form-item>	
					<el-form-item label="店主姓名">				        
					    <el-input type="text" class="ident-input" :disabled='update' v-model="identificationForm.store_keeper"></el-input>
					</el-form-item>
	...
	export default {
       ...
       methods: {
       	//获取单条信息
       	 GetIdentificationInfo:function(){
				...
				this.identificationForm = {
		          ...
		          store_keeper:res.data.data.store_keeper,
			...
			api.CrossShopReport(para).then((res) => {
				if(res.data.code == 200){
				    this.$message({
					message: '举报成功',
					type: 'success'
				});	
				this.addMessage('店铺举报反馈','您提交的店铺 "' +this.identificationForm.store_name+ '" 已处理')
				this.$router.push({path:'/ShopReportManage'});
				}else{
					this.$message({
	     ...
	     RejectIdent:function(){
			...
			api.RejectShopReport(para).then((res) => {
				console.log(res)
				if(res.data.code == 200){
				    this.$message({
					message: '已驳回',
				...
				this.addMessage('店铺举报反馈',this.return_reson)
